...
class TFrameworkTest {
    ...
    public void shouldInitializeFramework() {
        ...
        assertEquals("test", application.propertiesContainer().getPropertyValue("custom.string-prop").toString());
        assertEquals("1", application.propertiesContainer().getPropertyValue("custom.int-prop").toString());
        assertEquals("true", application.propertiesContainer().getPropertyValue("custom.boolean-prop").toString());
        assertEquals(
                List.of("test1", "test2", "test3").toString(),
                application.propertiesContainer().getPropertyValue("custom.list-prop").toString()
        );
    }
