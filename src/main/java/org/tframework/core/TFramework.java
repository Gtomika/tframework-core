...
/**
 * The core class of the framework, which includes methods to start and
 * stop a TFramework application.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class TFramework {

    /**
     * Start the TFramework application. This method is intended to be called from
