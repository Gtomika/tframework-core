...
public class TestUtils {
    ...
    /**
     * Dynamically sets environmental variables in memory. It will just be modified inside JVM, actual
     * system variables are not included.
     * @param newEnv Map of new variables.
     * @throws Exception If the setting is failed.
     * @author https://stackoverflow.com/a/7201825/4925616
     */
    ...
    @Test
    public void testSetEnvDynamically() throws Exception {
        String name = "TEST_DATA";
        String value = "TEST_VALUE";
        assertNull(System.getenv(name));
        setEnv(Map.of(name, value));
        String actualValue = System.getenv(name);
